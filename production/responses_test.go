...
func TestRecordAllResponses(t *testing.T) {
	...
	tests := []struct {
		...
		{"STO. Sedan no budget (ideal)", `{"city":"Riyadh","product":"STO","body_type":"Sedan"}`, TEST_API_KEY},
		{"STO. No-budget laddered alternative", `{"city":"Riyadh","product":"STO","query":"Zzz","body_type":"Sedan"}`, TEST_API_KEY},
		...
		{"STO. Min price + min year", `{"city":"Riyadh","product":"STO","min_price":2000,"min_year":2024}`, TEST_API_KEY},
		{"STO. Soft condition fallback", `{"city":"Riyadh","product":"STO","query":"Zzz","body_type":"Sedan","condition":"USED","max_price":4000}`, TEST_API_KEY},
		{"City. Unknown carries alternatives", `{"city":"Atlantis","product":"STO"}`, TEST_API_KEY},
